...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    header{position:sticky; top:0; z-index:60; display:flex; gap:12px; align-items: right; padding:10px 16px; background:rgba(3,6,8,0.7); backdrop-filter:blur(12px); border-bottom:1px solid rgba(255,255,255,0.05)}
    header img{height:40px; border-radius:8px}
    header h1{font-size:1rem; font-weight: 800; letter-spacing: -0.5px;}
    nav{margin-right:auto; display:flex; gap:15px; align-items:center}
